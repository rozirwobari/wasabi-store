...
@section('content')
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ url('dashboards/updateproduk') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="price-input-group">
                                    <input type="number" class="form-control" id="harga" name="harga" placeholder="0"
                                        min="1000" step="1000" value="{{ $produk->harga }}" required>
                                </div>
            ...
            <div class="form-step" data-step="3">
                <div class="form-card fade-in">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ url('dashboards/produk') }}" class="btn btn-secondary">
